...
By default, pic="wiki", but we can also use pic="phylopic" to get species silhouettes from the [phyloPics image repository](http://phylopic.org/). You can also supply your own images with pic="cust". 
...
Check out the vignette for showPhylo() to learn about more customizations. (not done yet)
